...
public class GridShadowCastersGenerator : MonoBehaviour
{
    ...
    public GameObject[] Generate()
    {
        ...
        for (int y = 0; y < countY; y++)
        {
            ...
            {
                hits[x, y] = IsHit(new Vector2(bottomLeft.x + (x * gridScale) + (0.5f * gridScale),
            ...
            for (int x = 0; x < countX; x++)
            {
                if (hits[x, y])
                {
                    ...
                    else
                    {
                        ...
                        currentInstance.transform.localScale = new Vector3(currentInstance.transform.localScale.x + 1.0f, currentInstance.transform.localScale.y, 0.0f);
                        currentInstance.transform.Translate(new Vector3(0.5f * gridScale, 0.0f, 0.0f));
                    }
            ...
            for (int x = 0; x < countX; x++)
            {
                ...
                if (bottomInstance != null && topInstance != null)
                {
                    if (bottomInstance != topInstance && bottomInstance.transform.localScale.x == topInstance.transform.localScale.x)
                    {
                        ...
                        bottomInstance.transform.Translate(new Vector3(0.0f, 0.5f * gridScale, 0.0f));
